...
\title{Demo Book}
\author{Desiree De Leon \and Alison Hill}
\date{2022-02-05}
...
\hypersetup{
  pdftitle={Demo Book},
  pdfauthor={Desiree De Leon; Alison Hill},
  hidelinks,
...
\NormalTok{  )}
\CommentTok{\#\textgreater{} Warning: knitr output format is not HTML. Use}
\CommentTok{\#\textgreater{} \textasciigrave{}include\_meta()\textasciigrave{} to ensure that the \textless{}meta\textgreater{} tags are properly}
\CommentTok{\#\textgreater{} included in the \textless{}head\textgreater{} output (if possible).}
\end{Highlighting}
\end{Shaded}
...
\includegraphics[width=7.08in]{/Users/christophergaskell/Desktop/leo-lurcher/book/nervous_leo2}
